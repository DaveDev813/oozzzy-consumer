    ...
    <div className="swiper-container hero-slider">
      <div className="swiper-wrapper dark-overlay">
        <div
          style={{
            backgroundImage:
              "url('static/img/photo/photo-1501621965065-c6e1cf6b53e2.jpg')"
          }}
        ...
        <div
          style={{
            backgroundImage:
              "url('static/img/photo/photo-1519974719765-e6559eac2575.jpg')"
          }}
          className="swiper-slide"
        />
        <div
          style={{
            backgroundImage:
              "url('static/img/photo/photo-1490578474895-699cd4e2cf59.jpg')"
          }}
          className="swiper-slide"
        />
        <div
          style={{
            backgroundImage:
              "url('static/img/photo/photo-1534850336045-c6c6d287f89e.jpg')"
          }}
          className="swiper-slide"
        />
      </div>
