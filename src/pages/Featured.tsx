...
const CardData2 = () => {
  return [
    {
      user: {
        src: "static/img/avatar/avatar-0.jpg",
        name: "Pamela",
        room: {
    ...
    {
      user: {
        src: "static/img/avatar/avatar-7.jpg",
        name: "John",
        room: {
    ...
    {
      user: {
        src: "static/img/avatar/avatar-8.jpg",
        name: "Julie",
        room: {
    ...
    {
      user: {
        src: "static/img/avatar/avatar-9.jpg",
        name: "Barbora",
        room: {
    ...
    {
      user: {
        src: "static/img/avatar/avatar-10.jpg",
        name: "Jack",
        room: {
    ...
    {
      user: {
        src: "static/img/avatar/avatar-11.jpg",
        name: "Stuart",
        room: {
                ...
                <div key={index} className="swiper-slide h-auto px-2">
                  ...
                  <div className="w-100 h-100">
                    <div className="card h-100 border-0 shadow">
                      ...
                      >
                        <Avatar
                          src="static/img/photo/photo-1484154218962-a197022b5858.jpg"
