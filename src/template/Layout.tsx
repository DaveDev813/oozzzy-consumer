...
import "../static/sampleTemplate/distribution/pages/css/style.default.css";
      ...
      <div className="container-fluid">
        <div className="d-flex align-items-center">
          <a href="index.html" className="navbar-brand py-1">
            <img
              src="../static/sampleTemplate/distribution/pages/img/logo.svg"
              alt="Directory logo"
            />
          </a>
    ...
    <div className="dropdown-menu megamenu py-lg-0">
      <div className="row">
        ...
        <div className="col-lg-3 d-none d-lg-block">
          <img
            src="../static/sampleTemplate/distribution/pages/img/photo/photo-1521170665346-3f21e2291d8b.jpg"
            alt=""
            className="bg-image"
          />
        </div>
...
const withLayout = Comp => {
  return () => (
    <div>
      ...
      <Comp />
      <script
        src={`../static/sampleTemplate/distribution/pages/vendor/jquery/jquery.min.js`}
      />
      <script
        src={`../static/sampleTemplate/distribution/pages/vendor/bootstrap/js/bootstrap.bundle.min.js`}
      />
      <script
        src={`../static/sampleTemplate/distribution/pages/vendor/magnific-popup/jquery.magnific-popup.min.js`}
      />
      <script
        src={`../static/sampleTemplate/distribution/pages/vendor/smooth-scroll/smooth-scroll.polyfills.min.js`}
      />
      <script
        src={`../static/sampleTemplate/distribution/pages/vendor/bootstrap-select/js/bootstrap-select.min.js`}
      />
      <script
        src={`../static/sampleTemplate/distribution/pages/vendor/object-fit-images/ofi.min.js`}
      />
      <script
        src={`https://cdnjs.cloudflare.com/ajax/libs/Swiper/4.4.1/js/swiper.min.js`}
      />
      <script src={`../static/sampleTemplate/distribution/pages/js/theme.js`} />
    </div>
  );
};
